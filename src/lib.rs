...
pub use agent::{
    add_specimen, apply_proposal, approve_proposal, benchmark_from_report, build_agent_report,
    build_pr_summary_for_task, build_production_agent_readiness,
    build_production_agent_v2_readiness, build_repo_map, build_task_outcome, create_task,
    detect_repair_bench_regressions, dry_run_apply, inspect_workspace, list_specimens,
    ...
    print_approve_proposal, print_create_task, print_doctor, print_external_trial, print_fix,
    print_plan_task, print_pr_summary_for_task, print_proposal_show, print_propose_task,
    print_repair_bench, print_repair_bench_gate, print_repair_bench_history, print_repo_map,
    ...
    refresh_all_task_outcomes, run_doctor, run_external_trial, run_fix, run_repair_bench,
    run_repair_bench_gate, run_repair_bench_history, run_validation, show_task,
    validate_patch_path,
};
...
pub use contracts::{
    ...
    ExternalPatchPackage, ExternalTrialRepoResult, ExternalTrialReport, ExternalTrialRequest,
    FinalRcReport, FitnessDecision, FixDetectedProblem, FixEvidencePaths, FixMode, FixOnly,
    FixProblemKind, FixReport, FixRequest, FixRiskCap, FixStatus, FuturePhaseEntry,
    FuturePhaseRegistry, GovernanceStatus, GovernanceTrustGate, LlmPurpose, LlmRequest,
    LlmResponse, LlmStatus, MutationContract, MutationKind, MutationObjective, MutationPlan,
    OperationsReport, OperatorApprovalRecord, OperatorConsoleReport, PatchOp, PatchOperationKind,
    PatchProposal, PlanStep, PrPackage, PrSummary, PreflightGateReport, PreflightGateV3Report,
    ProductionAgentReadiness, ProductionAgentV2Readiness, PromotionQueue, PromotionQueueItem,
    ProofReport, ProofSnapshot, ProposalStatus, RecombinedHypothesis, RecoveryManifest,
    ReleaseBundle, ReleaseCandidateApprovalReport, ReleaseCandidateState, ReleaseHealthReport,
    ReleaseLedgerRecord, ReleaseManifest, ReleasePreflightReport, ReleaseProposal,
    ReleaseProposalItem, RepairBenchBaseline, RepairBenchCase, RepairBenchCaseHistoryStatus,
    RepairBenchCaseResult, RepairBenchCaseStatus, RepairBenchEvidencePaths, RepairBenchGateReport,
    RepairBenchGateRequest, RepairBenchGateStatus, RepairBenchHistoryEntry,
    RepairBenchHistoryReport, RepairBenchMetricSummary, RepairBenchRegression, RepairBenchReport,
