...
pub use evolution::{
    ...
    load_recombined_hypotheses, load_report_json, print_benchmark, print_campaign,
    print_last_campaign_report, print_last_report, print_report, rank_plans, record_evolution,
    refresh_metrics, refresh_report, render_recombined_hypotheses, run_benchmark,
    run_planned_cycles, run_stored_campaign, run_task_from_path, score_cycle,
    top_recombined_hypothesis, update_metrics_after_log, validate_mutation, validate_task_contract,
    write_report, AutonomyStatus, DistilledPatternSummary, EvolutionBenchmark, EvolutionCampaign,
    EvolutionHypothesis, EvolutionMetrics, EvolutionScore, LearningContext,
};
