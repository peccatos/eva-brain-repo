...
pub use evolution::{
    ...
    build_determinism_audit, build_evidence_bundle, build_evolution_core_readiness,
    build_external_patch_package, build_final_rc_report, build_future_phase_registry,
    build_operations_report, build_operator_console_report, build_pr_package, build_preflight_gate,
    build_preflight_gate_v3, build_proof_report, build_proof_snapshot, build_recovery_manifest,
    build_release_bundle, build_release_candidate_state, build_release_health,
    ...
    classify_mutation_kind_label, classify_run_outcome, compute_quality_for_hypothesis,
    compute_quality_for_run, count_sandbox_leaks, default_corpus_contract, defer_candidate,
    distill_patterns, ensure_portfolio, evaluate_runtime_validation, fix_generated_test_names,
    generate_from_plan, generate_from_recombined_hypothesis, generate_safe_mutation,
    governance_status, governance_trust_gate, ingest_corpus, latest_corpus_id,
    latest_proof_snapshot_id, latest_record_for_run, latest_release_id, latest_supervised_run_id,
    learning_summary, list_adjusted_tasks, list_bounded_runs, list_corpora, list_evidence_bundles,
    ...
    promotion_ready_items, rank_plans, record_evolution, record_promotion_event,
    record_release_attempt, refresh_evolution_policy, refresh_metrics, refresh_portfolio,
    refresh_promotion_queue, refresh_report, refresh_strategy_portfolio, reject_candidate,
    release_count, release_ledger_count, release_proposal_count, render_recombined_hypotheses,
    run_benchmark, run_bounded_evolution, run_demo, run_evolution_hygiene, run_planned_cycles,
    run_stored_campaign, run_task_from_path, score_cycle, select_task_compatible_from_hypotheses,
